    ...
    actions: {
        ...
        item: {
            ...
            async handler(ctx) {
                ...
                const discount = await ctx.call('v1.discounts.findOne', {query: {_id: discountid}});
                if (!discount) {
        ...
        delete: {
            ...
            async handler(ctx) {
                ...
                await ctx.call('v1.discounts.deleteOne', {query: {_id: discountid}});

                await this.broker.emit('discount:deleted', {discount});
