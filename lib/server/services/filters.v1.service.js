    ...
    actions: {
        ...
        getGroup: {
            ...
            async handler(ctx) {
                ...
                const group = await ctx.call('v1.filters.findOne', {conditions: {_id: groupid}});
                if (!group) {
                    throw new MoleculerServerError('Group not found', 404);
                }
        ...
        deleteGroup: {
            ...
            async handler(ctx) {
                ...
                await ctx.call('v1.filters.deleteOne', {conditions: {_id: groupid}});
