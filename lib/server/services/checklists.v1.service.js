    ...
    actions: {
        ...
        item: {
            ...
            async handler(ctx) {
                ...
                const checklist = await ctx.call('v1.checklists.findOne', {query: {_id: checklistid}});
                if (!checklist) {
        ...
        delete: {
            ...
            async handler(ctx) {
                ...
                await ctx.call('v1.checklists.deleteOne', {query: {_id: checklistid}});
        ...
        selector: {
            ...
            cache: false,
            async handler(ctx) {
                return await this.adapter.model.find({}, 'id name items').sort('order').exec();
            }
        },
    }
};
