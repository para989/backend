    ...
    actions: {
        ...
        item: {
            ...
            async handler(ctx) {
                ...
                result.purchases = await ctx.call('v1.customer-seasons.purchases', {seasonid: season._id});
        ...
        delete: {
            ...
            async handler(ctx) {
                ...
                const season = await ctx.call('v1.seasons.findOne', {conditions: {_id: id}});
                if (!season) {
                    throw new MoleculerServerError(ctx.meta.__('season-not-found'), 404);
                }

                await ctx.call('v1.seasons.deleteOne', {conditions: {_id: id}});
