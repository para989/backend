        ...
        'order:created': {
            async handler(ctx) {
                ...
                if (giftid) {
                    ...
                    await this.adapter.model.updateOne({customer: customerid, gift: giftid}, {count: 0});
    ...
    actions: {
        ...
        charge: {
            ...
            async handler(ctx) {
                ...
                await this.adapter.model.updateOne(
                    {customer: customer._id, gift: gift._id},
                    {customer: customer._id, gift: gift._id, $inc: {count: 1}, $push: {logs: log}},
                    {upsert: true},
                );
