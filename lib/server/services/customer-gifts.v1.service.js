...
module.exports = {
            ...
            async handler(ctx) {
                ...
                if (count > 0) {
                    await ctx.call('v1.customer-gifts.updateOne', {
                        ...
                        doc: {customer: customerid, gift: giftid, $inc: {count: 1}},
                        options: {upsert: true},
                    });
                    await ctx.call('v1.notifications.push', {
                        customerid,
                        giftid,
                        title: map[giftid].name,
                        message: map[giftid].message,
                    });
                }
    ...
    actions: {
        ...
        delete: {
            ...
            rest: 'DELETE /user/customer-gifts/:id',
            params: {
                id: 'objectID',
            },
            async handler(ctx) {
