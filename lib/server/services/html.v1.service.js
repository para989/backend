    ...
    actions: {
        ...
        index: {
            ...
            async handler(ctx) {
                ...
                const promotions = showcase.promotions;
                _.each(promotions, promotion => {
                    switch (promotion.content.type) {
                        case 'promotion':
                            promotion.href = `#promotion-${promotion.content.value}`;
                            break;
                        case 'link':
                            promotion.href = promotion.content.value;
                            break;
                    }
                });
