        ...
        routes: [
            {
                ...
                aliases: {
                    ...
                    /* users */
                    "GET /users": "v1.users.items",
                    "GET /user/:userid": "v1.users.item",
                    "POST /user": "v1.users.add",
                    "PATCH /user": "v1.users.edit",
                    "DELETE /user/:userid": "v1.users.delete",
                    /* agreements */
                    ...
                    "GET /config/onesignal": "v1.config.getOneSignal",
                    "PATCH /config/onesignal": "v1.config.setOneSignal",
                    "GET /config/maps": "v1.config.getMaps",
                    "PATCH /config/maps": "v1.config.setMaps",
                    "GET /config/smtp": "v1.config.getSMTP",
                    "PATCH /config/smtp": "v1.config.setSMTP",
                    "GET /config/ucaller": "v1.config.getUcaller",
                    "PATCH /config/ucaller": "v1.config.setUcaller",
                    "GET /config/telegram": "v1.config.getTelegram",
                    "PATCH /config/telegram": "v1.config.setTelegram",
            ...
            },
            {
                ...
                aliases: {
                    ...
                    //"POST /favicon": "multipart:v1.images.favicon",
                }
            },
            {
                path: '/v1/user',
