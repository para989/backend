    ...
    actions: {
        ...
        item: {
            ...
            async handler(ctx) {
                ...
                result.purchases = await ctx.call('v1.customer-gifts.purchases', {giftid: gift._id});
        ...
        delete: {
            ...
            async handler(ctx) {
                ...
                const gift = await ctx.call('v1.gifts.findOne', {conditions: {_id: id}});
                if (!gift) {
                    throw new MoleculerServerError(ctx.meta.__('gift-not-found'), 404);
                }

                await ctx.call('v1.gifts.deleteOne', {conditions: {_id: id}});

                await ctx.call('v1.customer-gifts.deleteMany', {conditions: {gift: id}});
