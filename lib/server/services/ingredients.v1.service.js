    ...
    actions: {
        ...
        item: {
            ...
            async handler(ctx) {
                ...
                const ingredient = await ctx.call('v1.ingredients.findOne', {query: {_id: ingredientid}});
                if (!ingredient) {
        ...
        delete: {
            ...
            async handler(ctx) {
                ...
                await ctx.call('v1.ingredients.deleteOne', {query: {_id: ingredientid}});

                await this.broker.emit('ingredient:deleted', {ingredient});
