...
module.exports = {
    ...
    actions: {
        ...
        check: {
            ...
            async handler(ctx) {
                const user = await this.adapter.model.findOne({_id: ctx.params.userid});
        ...
        getQuestionnaire: {
            role: 'users:read',
            rest: 'GET /user/questionnaire/:userid',
            params: {
                userid: 'objectID',
            },
            async handler(ctx) {
