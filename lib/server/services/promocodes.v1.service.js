    ...
    actions: {
        ...
        delete: {
            ...
            async handler(ctx) {
                ...
                const promocode = await ctx.call('v1.promocodes.findOne', {query: {_id: id}});
                if (!promocode) {
                    throw new MoleculerServerError(ctx.meta.__('promocode-not-found'), 404);
                }

                await ctx.call('v1.promocodes.deleteOne', {query: {_id: id}});

                await this.broker.emit('promocode:deleted', {promocode});
        ...
        promocode: {
            ...
            async handler(ctx) {
                ...
                const promocode = await ctx.call('v1.promocodes.findOne', {query: {code: ctx.params.code}});
