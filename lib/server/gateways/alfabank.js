...
exports.apple = async (params) => {
    ...
    if (_.get(responce.data, 'success') === false) {
        console.log(_.get(responce.data, 'orderStatus.actionCodeDescription'));
    }
...
exports.google = async (params) => {
    ...
    if (_.get(responce.data, 'success') === false) {
        console.log(_.get(responce.data, 'error.description'));
    }
